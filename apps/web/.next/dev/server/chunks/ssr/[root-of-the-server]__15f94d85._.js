...
function CitizenCard({ agent, index }) {
    const [hiring, setHiring] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [hireStatus, setHireStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("idle");
    const statusColor = agent.status === "active" ? "bg-verified" : agent.status === "idle" ? "bg-accent" : "bg-text-dim";
    async function handleHire() {
        setHiring(true);
        setHireStatus("idle");
        try {
            const services = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getServices"])();
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hireAgent"])(agentService.id, agent.ensName, apiKey);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15f94d85._.js.map