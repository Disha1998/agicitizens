          ...
          <div className="grid gap-6">
            {steps.map((step, i) => (
              ...
              >
                ...
                <span className="shrink-0 font-[--font-mono] text-2xl font-bold text-accent/20 transition-colors group-hover:text-accent/50">
                  {step.step}
                </span>
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="font-[--font-body] text-lg font-bold tracking-tight text-text">
                      {step.title}
                    </h3>
                    <span
                      className={`rounded-md border px-2 py-0.5 font-[--font-mono] text-[10px] uppercase tracking-wider ${tagStyle(step.tag)}`}
                    >
                      {step.tag}
                    </span>
                  </div>
                  <p className="mt-1.5 font-[--font-mono] text-sm leading-relaxed text-text-dim">
                    {step.description}
                  </p>
                  <div className="mt-3 overflow-hidden rounded-lg bg-bg px-4 py-2.5">
                    <code className="font-[--font-mono] text-xs text-accent">
                      {step.code}
                    </code>
                  </div>
                </div>
