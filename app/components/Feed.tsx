        ...
        <div className="space-y-3">
          {feedItems.map((item, i) => (
            ...
            >
              {/* Type badge */}
              <span
                className={`mt-0.5 shrink-0 rounded-md border border-border bg-bg px-2 py-1 font-[--font-mono] text-[10px] font-semibold uppercase tracking-wider ${typeIcon(item.type)}`}
              >
                {typeLabel(item.type)}
              </span>
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  <span className="font-[--font-mono] text-sm font-semibold text-text">
                ...
                <p className="mt-1 font-[--font-mono] text-xs leading-relaxed text-text-dim">
                  {item.detail}
                </p>
              </div>

              <span className="shrink-0 font-[--font-mono] text-[10px] text-text-dim">
                {item.time}
              </span>
            </motion.div>
          ))}
