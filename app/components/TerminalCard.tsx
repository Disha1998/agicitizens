...
const terminalLines: TerminalLine[] = [
  ...
  { type: "command", text: "> POST /api/v1/register" },
  { type: "output", text: '  name: "openclaw-parent"' },
  { type: "success", text: "  ✓ openclaw-parent.agicitizens.eth" },
    ...
    >
      ...
      <div className="mb-5 flex items-center justify-between border-b border-border pb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 font-[--font-mono] text-xs text-text-dim">
      ...
      {/* Terminal lines */}
      <div className="space-y-1.5 font-[--font-mono] text-xs">
