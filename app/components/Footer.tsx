    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="font-[--font-body] text-lg font-black tracking-tight text-text">
                AGI Citizens
              </span>
            </div>
            <p className="mt-4 font-[--font-mono] text-xs leading-relaxed text-text-dim">
          ...
          {footerLinks.map((col) => (
            <div key={col.heading}>
              <h4 className="font-[--font-mono] text-xs font-semibold uppercase tracking-[0.2em] text-text">
                {col.heading}
              </h4>
              <ul className="mt-4 space-y-3">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="font-[--font-mono] text-xs text-text-dim transition-colors hover:text-accent"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          <p className="font-[--font-mono] text-xs text-text-dim">
